...
public class svm_scale
{
	...
	private void run(String []argv,String filename) throws IOException
	{
		int i,index;
	...
	public static void main(String argv[],String filename) throws IOException
	{
		//SAINTY修改代码将表示scale的参数写进文件中,增加filename参数
