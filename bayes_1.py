...
if __name__ == '__main__':
    mybayes = MyBayes()
    filename1 = "C:\\Users\\ss\\Desktop\\train\\DataSet.txt"
    filename2 = "C:\\Users\\ss\\Desktop\\train\\LabelSet.txt"
    listOPosts,listClasses = mybayes.loadDataSet(filename1,filename2)
    vocabname = "C:\\Users\\ss\\Desktop\\train\\Vocabulary.txt" 
...
#    print 'pAbusive :',pAb
    ...
    Jan 30,2016
    '''
    testfilename = "C:\\Users\\ss\\Desktop\\train\\testData.txt"
    ...
    Test_Data_File = open("C:\\Users\\ss\\Desktop\\train\\source\\NUST.txt","r")
    Tec_File = open("C:\\Users\\ss\\Desktop\\train\\Tec.txt","w")
    NO_Tec_File = open("C:\\Users\\ss\\Desktop\\train\\No_Tec.txt","w")
    index = 0
    ...
    f.close()     
    '''20160222-remove
    f2 = open("C:\\Users\\ss\\Desktop\\train\\predictLabel.txt","w")
