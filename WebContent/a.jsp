...
<html>
  <head>
    ...
    <link href="https://cdn.bootcss.com/jqueryui/1.11.4/jquery-ui.css" rel="stylesheet">
    ...
    { 
    	...
    	success:function(data)
    	{
    		...
    		if(sss=="ok")
    		{
    			document.getElementById("showOk").style.display = "block";
    		}
    		setTimeout(function()
    				{
    					document.getElementById("showOk").style.display = "none";
  ...
  <header class="main-header">
      ...
      <div id="backstageShow">
            ...
            <div>
              <button type="button" class="btn btn-primary btn-lg" id="button1" onclick="show()">Data Collection</button>
        ...
        <div class="result">
            ...
            <div id="content1" style="text-align:center;">
					<iframe  name="domainB"  width="100%" scrolling="yes" frameborder="0" src="c.html"></iframe>
            </div>
          </div>
         </div>
